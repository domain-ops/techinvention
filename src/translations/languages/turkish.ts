export const turkish = {
    ...
    "video": {
        ...
        "subtitle": "Bilimsel araştırmadan hayat kurtaran çözümlere",
        "tagline": "Biyoteknoloji İnovasyonunun Geleceğini Deneyimleyin"
    },
    "map": {
        "title": "Küresel Varlığımız",
        "subtitle": "Dünya çapında 85'ten fazla ülkeye sağlık çözümleri ulaştırıyoruz",
        "tag": "Küresel Varlık"
    },
    "hero": {
        ...
        "topTextRight": "Gelişmekte olan pazarlarda sağlık eşitliğini ve sürdürülebilir biyoüretimi destekliyoruz.",
        ...
        "requestConsultation": "Danışmanlık Talep Edin",
        "downloadApps": "Uygulamalarımızı indirin",
        "trustedGlobally": "Dünya çapında güvenilen.",
        "form": {
        ...
        "slides": [
            {
                "tag": "Aşılar",
                "title": "Öncü\nİmmünoterapi",
                "desc": "Küresel sağlık güvenliği için yeni nesil aşı platformları ve glikokonjugat teknolojileri geliştiriyoruz."
            },
            {
                "tag": "Tanı Çözümleri",
                "title": "Hassas\nTeşhis Sistemleri",
                "desc": "Hasta başında hızlı ve moleküler düzeyde doğru sonuç veren yenilikçi tanı kitleri."
            },
            {
                "tag": "Biyoterapötikler",
                "title": "İleri Biyolojik\nTedaviler",
                "desc": "Kronik ve bulaşıcı hastalıklara yönelik uygun maliyetli monoklonal antikorlar."
            },
            {
                "tag": "Fikri Mülkiyet",
                "title": "Stratejik\nIP Çözümleri",
    ...
    "about": {
        ...
        "values": {
            "title": "Değerlerimiz",
            "tagline": "TechInvention'da çalışmalarımız üç ana ilke etrafında şekillenir:",
            "footer": "Bu değerler sadece kelimelerden ibaret değildir; kararlarımızı belirler, kültürümüzü oluşturur ve küresel sağlık eşitliği misyonumuzu yönlendirir.",
            "innovationForHumanity": "İnsanlık İçin İnovasyon",
            "items": [
                {
                    "title": "Dürüstlük",
        ...
        "leadership": {
            ...
            "subtitle": "TechInvention'ı Şekillendiren Liderlik",
        ...
        "facilities": {
            "corporate": "Stratejik Genel Merkez",
            "lab": "İleri Araştırma Laboratuvarları",
            "manufacturing": "Küresel Üretim Tesisleri"
        },
        "features": [
            "Küresel Sağlık Ortaklıkları",
            "Yenilikçi mRNA Platformları",
            "Yeni Nesil Tanı Sistemleri",
            "GMP Uyumlu Biyoüretim"
        ],
        "yearsInnovation": "Yıllık İnovasyon",
        "countriesCovered": "Ulaşılan Ülke",
        "livesImpacted": "Etkilenen Hayat",
        "facility": "Tesis",
        "stats": {
            "countriesValue": "85+",
            "livesValue": "120M+"
        ...
        "responsibilityTitle": "Sorumluluğumuz",
        "responsibilityDesc": "Başarımızın, hizmet ettiğimiz toplumların refahı ve içinde faaliyet gösterdiğimiz çevre ile doğrudan bağlantılı olduğuna inanıyoruz.",
        "sustainableOps": "Sürdürülebilir Operasyonlar",
        "sustainableOpsDesc": "GMP standartlarındaki tesislerimiz, çevreye duyarlı üretimi sağlamak amacıyla özenle tasarlanmıştır.",
        "communityImpact": "Toplumsal Etki",
        "communityImpactDesc": "Stratejik girişimler ve küresel ortaklıklar aracılığıyla aşıları ve biyoterapötikleri ihtiyaç sahibi tüm topluluklara ulaştırmayı hedefliyoruz.",
        "scientificAdvisory": {
    ...
    "oneHealth": {
        ...
        "pillars": [
            {
                "title": "İnsan Sağlığı",
                "desc": "Öncelikli salgın hastalıklar ve dirençli patojenler için yeni nesil aşıların ve terapötiklerin geliştirilmesi."
            },
            {
                "title": "Hayvan Sağlığı",
                "desc": "Zoonotik hastalıkların insana geçişini kaynağında durdurmaya yönelik veteriner aşıları."
            },
            {
                "title": "Çevresel Sürdürülebilirlik",
                "desc": "Çevreye duyarlı yeşil biyoüretim süreçleri ve atık yönetimi stratejileri."
            }
        ],
    ...
    "solutions": {
        "tag": "Çözümlerimiz",
        "title": "Kapsamlı Biyoteknoloji Çözümleri",
        "globalHealthChallenges": "Küresel Sağlık Zorluklarına Karşı.",
        "desc": "Temel araştırmalardan ticari ölçekte üretime kadar.",
        "learnMore": "Daha Fazla Bilgi",
        "items": [
            {
                "title": "Aşı Geliştirme",
                "desc": "Hızlı yanıt ve kalıcı bağışıklık için tescilli mRNA ve viral vektör platformları."
            },
            {
                "title": "Tanı Platformları",
                "desc": "Moleküler hassasiyet ve yapay zeka analizleri sunan yeni nesil hasta başı tanı çözümleri."
            },
            {
                "title": "Biyoterapötikler",
                "desc": "Küresel sağlık etkisi için geliştirilmiş monoklonal antikorlar ve hücre tedavileri."
            },
            {
                "title": "Düzenleyici ve Ruhsat Desteği",
                "desc": "Karmaşık küresel mevzuat süreçleri ve tam uyumluluk için uçtan uca uzman rehberliği."
            },
            {
                "title": "GMP Üretim",
                "desc": "Hayati öneme sahip ilaçlara adil erişim sağlayan dağıtık üretim ağı."
            }
        ]
    },
    "impact": {
        "title": "Küresel Sağlıkta Somut Etki",
        "measuredInLives": "Kurtarılan Hayatlarla Ölçülür.",
        "desc": "Gelişmekte olan bölgelerdeki sağlık sistemleri için sürdürülebilir çözümler üretmek.",
        "rdGrowth": "Ar-Ge Büyüme Yörüngesi",
        "growth": "Büyüme",
        "impact": "Etki",
        "yearEst": "2025 Tahmini",
        "stats": {
            "countries": "Hizmet Verilen Ülkeler",
            "research": "Araştırma İş Birlikleri",
            "products": "Geliştirme Aşamasındaki Ürünler",
            "partnerships": "Küresel Ortaklıklar"
        },
        "tag": "Etkimiz"
    },
    "caseStudy": {
        "titlePrefix": "Öne Çıkan",
        "titleHighlight": "Vaka Çalışmaları",
        "desc": "İş ortaklarımızın karmaşık biyoteknoloji zorluklarını aşmalarına nasıl yardımcı olduğumuzu keşfedin.",
        "tag": "Vaka Çalışması",
        "features": [
            {
                "label": "Aşılar",
                "desc": "Hızlı ölçek büyütme ile hayat kurtaran aşılara küresel erişimi hızlandırma."
            },
            {
                "label": "Tanılar",
                "desc": "Daha hızlı ve doğru hastalık tespiti için yenilikçi test kitlerine öncülük etme."
            },
            {
                "label": "Biyoterapötikler",
                "desc": "Karmaşık kronik durumları tedavi etmek için gelişmiş biyolojik tedaviler geliştirme."
            },
            {
                "label": "Klinik Çalışmalar",
                "desc": "Hasta güvenliğini sağlamak için titiz ve etik çok aşamalı klinik çalışmalar yürütme."
            },
            {
                "label": "Küresel Sağlık",
                "desc": "Sağlık sistemlerini güçlendirme ve dünya çapında adil erişimi teşvik etme."
            },
            {
                "label": "Ar-Ge İnovasyonu",
                "desc": "Tıp biliminin geleceğini şekillendirmek için en son teknolojilerden yararlanma."
            },
            {
                "label": "Kalite Kontrol",
                "desc": "Üretim saflığı ve kalitesinde en yüksek uluslararası standartlara bağlılık."
            },
            {
                "label": "Terapötikler",
                "desc": "Özel tıbbi karşı önlemler için uyarlanmış hedefe yönelik tedaviler sunma."
            }
        ],
    ...
    "blogs": {
        "titlePrefix": "En Güncel",
        "titleHighlight": "Görüşler ve Yayınlar",
        "desc": "Bilimsel keşiflerimiz ve endüstriyel başarılarımızdan haberdar olun.",
        "viewAll": "Tüm Blogları Görüntüle",
        "readMore": "Devamını Oku",
        "items": [
            {
                "title": "Gelişmekte Olan Pazarlarda Aşı Üretiminin Geleceği",
                "excerpt": "Yerel üretim yetkinliklerinin küresel tedarik eşitsizliklerini nasıl kalıcı olarak azaltabileceğini keşfedin.",
                "date": "12 Ekim 2023",
                "category": "İnovasyon",
                "author": "TechInvention Ekibi"
            },
            {
                "title": "Yeni Nesil Sağlık Hizmetleri İçin Hızlı Teşhis Araçlarında İnovasyonlar",
                "excerpt": "Hasta başında hızlı ve kesin sonuçlar sağlamak üzere tasarlanmış en yeni tanı çözümlerimize derinlemesine bakış.",
                "date": "5 Kasım 2023",
                "category": "Araştırma",
                "author": "Dr. Elena Rodriguez"
            },
            {
                "title": "Tıbbi Kaynak Eşitliği İçin Küresel Ortaklıkların Güçlendirilmesi",
                "excerpt": "Evrensel sağlık güvenliğini sağlamak için kamu ve özel sektör iş birliğinin neden vazgeçilmez olduğu.",
                "date": "20 Aralık 2023",
                "category": "Teknoloji",
                "author": "TechInvention Ekibi"
            }
        ],
        "tag": "Haberler ve Yayınlar",
        "title": "Güncel Görüşler ve Yayınlar"
    },
    "glanceVideo": {
        "titlePrefix": "TechInvention",
        "titleHighlight": "Bir Bakışta",
        "title": "Bir Bakışta TechInvention",
        "desc": "Misyonumuzu, tesislerimizi ve ekibimizi çalışırken izleyin."
    },
    "cta": {
        "tag": "Harekete Geçin",
    ...
    "loader": {
        "initializing": "Bio-Sync Başlatılıyor",
        "loading": "TechInvention yükleniyor..."
    },
    "homeStats": {
        "header": {
            "tag": "Etkimiz",
            "title1": "Mükemmelliği ",
            "title2": "Ölçmek",
            "desc": "Küresel sağlık eşitliğine olan bağlılığımız, yalnızca yenilikçi portföyümüzde değil, sınırlar ötesinde yarattığımız ölçülebilir etkide de kendini göstermektedir."
        },
        "awards": {
            "value": "10+",
            "label": "Yıl",
            "desc": "Biyoteknoloji inovasyonu ve üretiminde kanıtlanmış deneyim"
        },
        "experts": {
            "value": "20+",
            "label": "Proje",
            "desc": "Aşı ve sağlık alanında başarıyla tamamlanan küresel projeler"
        },
        "patients": {
            "value": "15+",
            "label": "Ülke",
            "desc": "Teknolojilerimiz ve iş birliklerimizle ulaşılan ülkeler"
        },
        "partners": {
            "value": "10+",
            "label": "Küresel İş Ortağı",
            "desc": "Dünya çapında önde gelen sağlık kuruluşları ve enstitüler"
        }
    },
    "globalProjects": {
        ...
        "locations": [
            ...
            },
            {
                "id": "africa",
                "name": "Afrika",
                "type": "Üretim ve Dağıtım Merkezi",
                "count": "8+ Proje",
                "coords": [
                    24,
                    -29
            ...
            },
            {
                "id": "nigeria",
                "name": "Nijerya",
                "type": "Dağıtım ve Tedarik Merkezi",
                "count": "5+ Proje",
                "coords": [
                    8,
                    9
    ...
    "vaccinePipeline": {
        ...
        "milestonesTitle": "Öngörülen Temel Kilometre Taşları",
        "milestonesTitleShort": "Temel Kilometre Taşları:",
        "target": "Hedef:",
        "targetAdults": "Yetişkinler",
        "targetInfants": "Bebekler",
        "announceSafety": "Güvenlilik verilerinin açıklanması:",
        "phase3Trials": "2027 1. Yarıyılda Faz 3 klinik çalışmaları²",
        "phase": "Aşama",
        ...
        "items": [
            {
                "name": "Pnömokok Konjuge Aşısı (16-valanlı)",
                "progress": 75,
                "color": "#1955A6"
            },
            {
                "name": "Heksavalan Meningokok Aşısı (ABCYWX)",
                "progress": 50,
                "color": "#129B9C"
            },
            {
            ...
            {
                "name": "Tüberküloz Aşısı",
                "progress": 50,
                "color": "#129B9C"
            }
        ],
        "desc": "Öncelikli bulaşıcı hastalıkları ve antimikrobiyal direnci hedefleyen ileri düzey programlar."
    },
    "biotherapeuticsPipeline": {
        "title": "Biyoterapötik Portföyü",
        "pipeline": "Portföy",
        "items": [
            {
                "name": "Rekombinant İnsan Eritropoietini",
                "phase": "Faz 3",
                "color": "#2065B3",
                "desc": "Anemi tedavisi için"
            },
            {
                "name": "Pegfilgrastim",
                "phase": "Klinik Öncesi",
                "color": "#87A840",
                "desc": "Nötropeni tedavisi için"
            }
        ],
        "tag": "Biyoterapötikler",
        "desc": "Erişilebilir ve yenilikçi biyolojik tedavi çözümleri."
    },
    "journeyPipeline": {
        "tag": "Etkimiz",
        "title1": "Aşı ve Biyoterapötik Portföyü",
        "title2": "Keşif | Kavram Kanıtlama | Klinik Öncesi | Faz 1/2",
        "phases": [
            "Keşif",
            "Kavram Kanıtlama",
            "Klinik Öncesi",
        ...
        "boxes": [
            {
                "title": "Pnömokok Konjuge Aşısı (16-valanlı)",
                "desc": "İleri glikokonjugat platform",
                "phase": "Kavram Kanıtlama"
            },
            {
                "title": "Heksavalan Meningokok Aşısı (ABCYWX)",
                "desc": "Meningokoklara karşı geniş koruma",
                "phase": "Klinik Öncesi"
            },
            {
                "title": "Pan-Salmonella Aşısı",
                "desc": "Kritik Salmonella suşlarını hedefler",
                "phase": "Keşif"
            },
            {
                "title": "Shigella Aşısı",
                "desc": "Yenilikçi glikokonjugat aşı",
                "phase": "Kavram Kanıtlama"
            },
            {
                "title": "Meningococcal B Aşısı",
                "desc": "Rekombinant protein platformu",
                "phase": "Klinik Öncesi"
            },
            {
                "title": "Sıtma Aşısı",
                "desc": "Yeni nesil aşı adayı",
                "phase": "Keşif"
            },
            {
                "title": "Tüberküloz Aşısı",
                "desc": "TBVI tarafından karşılaştırmalı değerlendirme için seçildi",
                "phase": "Klinik Öncesi"
            }
        ]
    },
    "membership": {
        "tag": "Ağ",
        "title": "Küresel Üyelikler ve İş Birlikleri",
        "membership": "Üyelikler",
        "desc": "Önde gelen bilimsel kuruluşlar ve uluslararası ağlarla ortaklıklar.",
        "membersTitle": "Üye Kuruluşlarımız",
        "howToJoin": "Üye Olun",
        "joinDesc": "Sağlıkta eşitliği gerçeğe dönüştüren ayrıcalıklı inovasyon ağımıza katılın."
    },
    "certifications": {
        "tag": "Kalite ve Uyum",
        ...
        "list": {
            "drugFreePledge": {
                ...
                "year": "2026",
                "info": "TechInvention Lifecare Limited, Maharashtra Hükümeti'nin Uyuşturucusuz Mumbai Girişimi'ne resmi olarak destek taahhüdünde bulunmuştur."
            },
            "dnb": {
        ...
        "items": [
            {
                "date": "Mart 2026",
                "category": "İnovasyon",
                "title": "TechInvention, Güneydoğu Asya'da mRNA Teknolojisini Genişletiyor",
                "desc": "Bölgesel aşı üretimini artırmak için yeni teknoloji transferi girişimlerine öncülük ediyoruz.",
                "image": "news_mrna"
            },
            {
                "date": "Şubat 2026",
                "category": "Ortaklık",
                "title": "Global Sağlık İttifakı, TechInvention'ı Stratejik Ortak Olarak Belirledi",
                "desc": "Hizmete erişimi kısıtlı topluluklar için uygun fiyatlı tanı çözümlerini hızlandırmak üzere güçlerimizi birleştiriyoruz.",
                "image": "news_partnership"
            },
            {
                "date": "Ocak 2026",
                "category": "Araştırma",
                "title": "Yeni Nesil Salmonella Aşısında Önemli Başarı",
                "desc": "NexGen Salmonella aşı adayımız için klinik öncesi denemelerde başarılı sonuçlar elde edildi.",
                "image": "news_mrna"
            }
        ]
    },
    ...
    "elegantCarousel": {
        "slides": [
            {
                "title": "Hassas Tanı",
                "subtitle": "Biyo-İnovasyon Merkezi",
                "description": "Moleküler hassasiyet ve yapay zeka analizleriyle donatılmış yeni nesil hasta başı tanı çözümleri.",
                "accent": "#1755A6",
                "imageUrl": "diagnostics"
            },
            {
                "title": "Aşı Portföyü",
                "subtitle": "Ar-Ge İnovasyonları",
                "description": "Küresel sağlığı korumak amacıyla mRNA ve viral vektör platformlarını kullanan yeni nesil aşıların öncüsü.",
                "accent": "#5C7625",
                "imageUrl": "vaccine"
            },
            {
                "title": "Küresel Sağlık Eşitliği",
                "subtitle": "Tek Sağlık Vizyonu",
                "description": "Küresel sağlık eşitsizliğini azaltmak için erişilebilir, güvenilir ve uygun maliyetli biyoteknoloji çözümleri.",
                "accent": "#A3611C",
                "imageUrl": "equity"
            },
            {
                "title": "Stratejik Fikri Mülkiyet Çözümleri",
                "subtitle": "Küresel Uyumluluk",
                "description": "Patent araştırmaları, teknoloji lisanslama ve küresel fikri mülkiyet danışmanlığı için kapsamlı destek.",
                "accent": "#565658",
                "imageUrl": "ip"
            }
        ],
        "title": "Platform Mükemmeliyeti"
    },
    "atAGlance": {
        "tag": "Göstergeler",
        ...
        "title2": "Bir Bakışta",
        "title": "Bir Bakışta",
        "subtitle": "Rakamlarla Ekosistemimiz ve Etkimiz",
        "desc": "Küresel sağlıkta eşitliğe adanmış entegre altyapılar."
    },
    "strategicAdvisory": {
        ...
        "sections": [
            {
                ...
                "content": "Gelişmekte olan ülkelerde yerel aşı üretimini mümkün kılmak için kapsamlı pazar, teknik ve finansal fizibilite çalışmaları sunuyoruz.",
                "deliverablesTitle": "Çıktılarımız şunları içerir:",
                "deliverables": [
                    "Pazar talebi ve epidemiyolojik modelleme",
                    "Teknik ve tesis gereksinimleri analizi",
                    "Mali fizibilite ve yatırım getirisi projeksiyonları",
                    "Mevzuat ve ruhsatlandırma yol haritası",
                    "Boşluk analizi raporu",
                    "Tekno-ticari analiz raporu"
                ]
            },
            {
                "title": "Pazar Değerlendirmeleri",
                "content": "Aşı ve biyofarma sektöründe hedef pazarlar için talep tahminleri, fiyatlandırma stratejileri ve rekabet analizleri sağlıyoruz.",
                "deliverablesTitle": "Temel odak alanları:",
                "deliverables": [
                    "Küresel ve bölgesel aşı talebi analizi",
                    "Kamu ihale ve tedarik dinamikleri",
                    "Fiyatlandırma ve maliyet optimizasyonu",
                    "Ticari giriş stratejileri"
                ]
            },
            {
                "title": "Teknoloji Transferi ve Lisanslama",
                "content": "Kanıtlanmış aşı üretim süreçlerinin laboratuvardan ticari tesislere sorunsuz aktarımı ve lisanslama yönetimi.",
                "deliverablesTitle": "Transfer kapsamı:",
                "deliverables": [
                    "Proses ve analitik yöntem transferi",
                    "Know-how ve teknoloji paketleri",
                    "GMP validasyon protokolleri",
                    "Personel eğitimi ve yerinde destek"
                ]
            },
            {
                "title": "Tesis Konsept Tasarımı ve Mühendislik",
                "content": "WHO, US FDA ve AB GMP standartlarına uygun modern biyofarma ve aşı üretim tesisleri için mühendislik danışmanlığı.",
                "deliverablesTitle": "Mühendislik hizmetleri:",
                "deliverables": [
                    "Konsept ve detay tasarım",
                    "Temiz oda ve HVAC optimizasyonu",
                    "Ekipman şartnameleri ve URS",
                    "Devreye alma ve kalifikasyon (DQ/IQ/OQ/PQ)",
                    "Ekipman tedarik ve spesifikasyonları",
                    "Alan yönetimi ve maliyet optimizasyonları",
                    "Bina bilgi sistemleri ve otomasyon"
                ]
            },
            {
                "title": "Kalite Yönetim Sistemleri (QMS) ve WHO-PQ Desteği",
                "content": "Dünya Sağlık Örgütü Ön Yeterliliği (WHO-PQ) ve uluslararası regülasyonlara uyum için uçtan uca stratejik rehberlik ve denetim hazırlığı.",
                "deliverablesTitle": "Çıktılarımız şunları içerir:",
                "deliverables": [
                    "Tesis ve ürün için WHO TRS boşluk analizi",
                    "Tüm QMS sistemlerinin deneme denetimi (Mock audit)",
                    "İç denetim bulgularına uyum sağlama",
                    "WHO ile ön yeterlilik görüşmeleri",
                    "Denetim sonrası CAPA takip ve uyumu",
                    "Denetim sonrası CAPA sunumu ve mevzuat uyumu"
                ]
            }
        ],
        "callToAction": "Stratejik İş Birliği Başlatın",
        "testimonials": [
            {
                "client": "Dünya Sağlık Örgütü (WHO)",
                "feedback": "TechInvention'ın stratejik rehberliği, bölgesel aşı üretim kapasitesinin geliştirilmesinde kritik bir rol oynamıştır."
            },
            {
                "client": "UNOPS",
                "feedback": "Uygulamalı teknik uzmanlıkları ve küresel standartlara hakimiyetleri ile projelerimize benzersiz bir değer kattılar."
            },
            {
                "client": "UNOPS – Aşı Analitiği Eğitimi",
                "feedback": "TechInvention, sanal öğrenimi tesis bazlı pratik oturumlarla birleştiren kapsamlı bir aşı analitiği eğitim programını başarıyla gerçekleştirdi."
            },
            {
                "client": "Dünya Sağlık Örgütü (WHO SEARO)",
        ...
        "services": [
            {
                "title": "Mevzuat ve Ruhsatlandırma Stratejisi"
            }
        ]
    },
    "cdmo": {
            ...
            "features": [
                {
                    ...
                    "desc": "Proses geliştirmeden dolum ve bitirmeye, ruhsatlandırma hazırlığından teknoloji transferine kadar aşı geliştirmenin her aşamasını destekleyen entegre uzmanlık."
                },
                {
                    "title": "Uluslararası Kalite Standartları",
                    "desc": "Küresel GMP beklentileri doğrultusunda tasarlanmış üretim altyapısı, güçlü kalite sistemleri ve tam mevzuat uyumu."
                },
                {
                    "title": "Esnek Üretim",
                ...
                },
                {
                    ...
                    "desc": "Üretim mükemmelliğini korurken çevresel etkiyi azaltmak için tasarlanmış enerji tasarruflu altyapı ve akıllı tesis yönetim sistemleri."
                }
            ]
        },
        ...
        "qcLab": {
            ...
            "title": "Kalite Kontrol Laboratuvarı ve Analitik Destek",
            "inProcess": "Proses İçi Testler",
            "inProcessDesc": "Tüm kritik üretim aşamalarında gerçek zamanlı izleme ve ileri analitik kontroller.",
            "release": "Seri Serbest Bırakma Testleri",
            "releaseDesc": "Katı küresel farmakope standartlarına uygun kapsamlı nihai ürün analizleri.",
            "stability": "Stabilite Çalışmaları",
            "stabilityDesc": "Uzun süreli ve hızlandırılmış testler için ICH uyumlu stabilite kabinleri."
        },
        "techTransfer": {
            "title": "Teknoloji Transferi Hazırlığı",
            "desc": "Ar-Ge'den tam ölçekli ticari üretime sorunsuz geçişi sağlayan titiz ve yapılandırılmış bir süreç.",
            "step1Title": "Teknik Dosya Kabulü (Tech Pack)",
            "step1Desc": "Süreç ve analitik yöntemlerin kapsamlı incelemesi.",
            "step2Title": "Proses Uyarlaması",
            "step2Desc": "Tesis uygunluk analizi ve ölçek büyütme mühendisliği.",
            "step3Title": "Mühendislik Deneme Serileri",
            "step3Desc": "Proses parametrelerini doğrulamak için GMP dışı deneme partileri.",
            "step4Title": "GMP Standartlarında Üretim",
            "step4Desc": "Uluslararası standartlarda klinik ve ticari üretim."
        },
        "drugProductTitle": "Bitmiş Ürün Formülasyonu ve Dolumu",
        "drugProductDesc": "Steril dolum ve bitirme operasyonlarımız, en yüksek düzeyde sterilite güvencesi sağlamak için son teknoloji izolatör ve RABS sistemlerini kullanır.",
        "readyCommercial": "Ticari ölçekte ambalajlamaya hazır",
        "liquidVials": "Sıvı ve Liyofilize Flakonlar",
        "liquidVialsDesc": "Gelişmiş izolatör teknolojisi ile entegre yüksek hızlı aseptik dolum hatları.",
        "pfs": "Kullanıma Hazır Enjektörler (PFS)",
        "pfsDesc": "Maksimum sterilite için sıkı çevre kontrolleri altında otomatik PFS dolumu.",
        "upstream": "Yukarı Akış İşleme (Upstream)",
        "upstreamDesc": "2000L kapasiteye kadar ölçeklenebilir biyoreaktörler",
        "downstream": "İleri Aşağı Akış İşleme (Downstream)",
        "downstreamDesc": "Hassas saflaştırma ve kromatografi",
    ...
    "training": {
        ...
        "testimonials": [
            ...
            },
            {
                ...
                "org": "Sağlık Bakanlığı / ShieldVax Projesi",
                "feedback": "Tüm üretim aşamalarında aşı kalite kontrol testlerine ilişkin uçtan uca, uygulamalı deneyim kazandım."
            },
            {
                "author": "Mr. Kebede Fufa",
                "role": "KYS Sorumlusu",
                "org": "Etiyopya Gıda ve İlaç Kurumu (EFDA)",
    ...
    "contactDocs": {
        "title": "Ürün ve Teknik Dokümantasyon Talebi",
        "subtitle": "Dossier, teknik veri sayfaları ve ürün spesifikasyonları için bizimle iletişime geçin.",
        "connectDesc": "Ortaklıklar, ürün talepleri, Ar-Ge iş birlikleri veya tesis danışmanlığı için ekibimizle iletişime geçin.",
        "address1Title": "Genel Merkez ve Üretim Tesisi",
        "address1": "Plot No. EL-40, Mahape MIDC Electric Zone, MIDC Industrial Area, Mahape Village, Navi Mumbai, Maharashtra 400710, Hindistan",
    ...
    "products": {
        ...
        "diagFeat4": "Uluslararası Mevzuata Uygun",
        "advancedDiagTitle": "Gelişmiş Tanı Çözümleri",
        "advancedDiagDesc": "Dünya genelinde bulaşıcı hastalıklarla mücadele etmek için hızlı ve sağlam test teknolojileriyle tanıda dönüşüm yaratıyoruz.",
        "precisionAssays": "Hassas Analizler",
        "goldStandard": "Altın standart performans",
        "rapidDiagnostics": "Hızlı Tanı Kitleri",
        "lfaTitle": "Yanal Akış Testleri (LFA)",
        "lfaDesc": "Bulaşıcı ve kronik durumlar için gerçek zamanlı güvenilir sonuçlar sağlayan hasta başı hızlı tanı çözümleri.",
        "rapidTest": "Hızlı Test",
        ...
        "vetDesc": "Evcil hayvanlar ve çiftlik hayvanlarının sağlık takibi için hızlı ve hassas veteriner tanı çözümleri.",
        "vetProductsBtn": "Veteriner Ürünlerini Görüntüle",
        "vetItems": [
            {
                "title": "Evcil Hayvan Testleri",
                "desc": "Evcil hayvan sağlığı için hızlı ve hassas tanı testleri."
            },
            {
                "title": "Çiftlik Hayvanı Sağlık Takibi",
                "desc": "Sürüler ve kümes hayvanları için proaktif tarama ve hastalık gözetimi."
            },
            {
    ...
    "gmpTraining": {
        "curriculumTitle": "Kapsamlı GMP Eğitim Müfredatı",
    ...
    "thankYou": {
        ...
        "desc": "Mesajınız başarıyla alındı. Ekibimiz en kısa sürede sizinle iletişime geçecektir.",
        "button": "Ana Sayfaya Dön"
    },
    "search": {
        "showingResults": "Arama sonuçları:",
        "enterPrompt": "Ürünler, aşılar, haberler ve belgeler için bir arama terimi girin",
    ...
    "home": {
        "cta": {
            "desc": "Aşılar ve biyoterapötiklerde üretim ortaklıklarını keşfetmek için bizimle iletişime geçin."
        }
    }
};
