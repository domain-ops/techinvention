export const spanish = {
    ...
    "megaMenu": {
        ...
        "ipPortfolio": "Portafolio de PI NexGen",
        "services": "Servicios",
        "aboutUs": "Nosotros",
        ...
        "animalVaccines": "Vacunas Veterinarias",
        "pipeline": "Portafolio en Desarrollo",
        "molecular": "Diagnóstico Molecular",
        "rapidTest": "Pruebas Rápidas",
        "oneHealth": "Iniciativa One Health",
        "strategicAdvisory": "Asesoría Estratégica",
        ...
        "technologyTransfer": "Transferencia de Tecnología",
        "memberships": "Membresías y Redes",
        "caseStudies": "Estudios de Caso",
        "whitePapers": "Informes Técnicos",
        "newsMedia": "Noticias y Medios",
        "faqs": "Preguntas Frecuentes (FAQ)",
        "technicalSupport": "Soporte Técnico y Consultoría",
        "awards": "Premios y Reconocimientos",
        "products": "Detalles del Producto",
        "veterinary": "Salud Animal",
        "licensing": "Transferencia de Tecnología"
    },
    "video": {
        "title": "Innovación Biotecnológica Global",
        "subtitle": "De la investigación científica a terapias que salvan vidas",
        "tagline": "Experimente el Futuro de la Innovación Biotecnológica"
    },
    "map": {
        "title": "Presencia Global",
        "subtitle": "Soluciones sanitarias que llegan a más de 85 países en todo el mundo",
        "tag": "Presencia Global"
    },
    "hero": {
        "badge": "Liderazgo en Biotecnología",
        "heading": "Innovación para el Impacto en la Salud Global",
        "tagline": "Pioneros en el desarrollo de vacunas, diagnósticos avanzados y biomanufactura sostenible para promover la equidad en salud en todo el mundo.",
        "exploreSolutions": "Explorar Soluciones",
        "ourVision": "Nuestra Visión",
        "topTextLeft": "Excelencia Global en Biotecnología y Desarrollo de Vacunas.",
        "topTextRight": "Impulsamos la equidad sanitaria y la biomanufactura sostenible en mercados emergentes.",
        "bottomTitle": "Biotecnología de Próxima Generación",
        "bottomSub": "Desarrollo integral de vacunas y capacidades de manufactura a escala global",
        "rotatingWords": [
            "Diagnósticos",
            "Vacunas",
            "Bioterapéuticos"
        ...
        "secondaryCta": "Sea Nuestro Socio",
        ...
        "downloadApps": "Descargue nuestras aplicaciones",
        ...
        "slides": [
            {
                "tag": "Vacunas",
                "title": "Pioneros en\nInmunoterapia",
                "desc": "Desarrollamos plataformas de vacunas de próxima generación y tecnologías glicoconjugadas para la seguridad sanitaria mundial."
            },
            {
                "tag": "Diagnósticos",
                "title": "Sistemas de\nDiagnóstico de Precisión",
                "desc": "Kits de diagnóstico innovadores que brindan resultados moleculares instantáneos y confiables en el punto de atención."
            },
            {
                "tag": "Bioterapéuticos",
                "title": "Terapias Biológicas\nAvanzadas",
                "desc": "Anticuerpos monoclonales accesibles para el tratamiento de enfermedades crónicas e infecciosas."
            },
            {
                "tag": "Propiedad Intelectual",
                "title": "Soluciones de\nPI Estratégica",
                "desc": "Mapeo de patentes y gestión de licencias tecnológicas para maximizar el impacto en la salud mundial."
            }
        ]
    },
    "testimonials": {
    ...
    "about": {
        ...
        "leadership": {
            ...
            "team": {
                ...
                "tagline": "Las Mentes Detrás de la Innovación",
                "cta": "Nuestro equipo diverso de científicos, ingenieros y profesionales de la salud se une con un único propósito: generar un impacto global positivo y duradero.",
                "members": [
                    {
                        "name": "Dr. Elena Rodriguez",
                        "role": "Directora de I+D en Vacunas",
                        "bio": "Especialista en inmunología clínica con más de 20 años de experiencia liderando investigaciones en ARNm y vectores virales."
                    },
                    {
                        "name": "Marcus Chen",
                        "role": "Director de Operaciones Globales",
                        "bio": "Experto en logística de cadena de frío y manufactura biológica distribuida en el mundo en desarrollo."
                    },
                    {
                        "name": "Sarah Al-Farsi",
                        "role": "Ingeniera Principal de Diagnóstico",
                        "bio": "Lidera plataformas de diagnóstico en el punto de atención con precisión molecular e integración de IA."
                    },
                    {
                        "name": "David Okoro",
                        "role": "Director de Asuntos Regulatorios",
                        "bio": "Supervisa el cumplimiento global y gestiona procesos complejos de precalificación de la OMS y agencias internacionales."
                    },
                    {
                        "name": "Dr. Priya Sharma",
                        "role": "Directora Científica Principal (CSO)",
                        "bio": "Guía nuestro portafolio de investigación con más de 15 años de trayectoria en biotecnología avanzada."
                    },
                    {
                        "name": "Arjun Mehta",
                        "role": "Director de Manufactura",
                        "bio": "Responsable de asegurar la operatividad impecable y los estándares de calidad en nuestras plantas GMP."
                    },
                    {
                        "name": "Dr. Fatima Al-Hassan",
                        "role": "Directora de Desarrollo Clínico",
                        "bio": "Coordina las estrategias preclínicas y clínicas de nuestros candidatos a vacunas de nueva generación."
                    },
                    {
                        "name": "James Obi",
                        "role": "Director de Desarrollo de Negocios",
                        "bio": "Especialista en alianzas estratégicas y acceso al mercado en África y el Sudeste Asiático."
                    }
                ]
            },
            ...
            "board": [
                ...
                {
                    "name": "Sra. Monika Thanvi",
                    "role": "Directora Independiente"
                },
                {
                    "name": "Sr. Gopal Damisetti",
                    "role": "Director Independiente"
                }
            ]
        },
        "facilities": {
            "corporate": "Sede Corporativa Estratégica",
            "lab": "Laboratorios de Investigación Avanzada",
            "manufacturing": "Instalaciones de Biomanufactura"
        },
        "features": [
            "Alianzas de Salud Global",
            "Plataformas Innovadoras de ARNm",
            "Diagnósticos de Próxima Generación",
            "Biomanufactura Cumpliendo GMP"
        ],
        "yearsInnovation": "Años de Innovación",
        "countriesCovered": "Países Atendidos",
        ...
        "responsibilityTitle": "Nuestra Responsabilidad",
        "responsibilityDesc": "Creemos que nuestro éxito está fundamentalmente vinculado al bienestar de las comunidades a las que servimos y al medio ambiente.",
        "sustainableOps": "Operaciones Sostenibles",
        "sustainableOpsDesc": "Nuestras instalaciones tipo GMP están diseñadas cuidadosamente para permitir una producción ambientalmente responsable.",
        "communityImpact": "Impacto Comunitario",
        "communityImpactDesc": "A través de iniciativas estratégicas y alianzas globales, nuestro objetivo es hacer que las vacunas sean accesibles para poblaciones vulnerables.",
        "scientificAdvisory": {
            "title": "Consejo Asesor Científico",
            "desc": "Reuniendo a destacados líderes científicos cuya experiencia fortalece nuestra agenda de investigación e innovación en vacunas."
        }
    },
    "oneHealth": {
        ...
        "pillars": [
            {
                "title": "Salud Humana",
                "desc": "Desarrollo de vacunas y terapias de vanguardia dirigidas a patógenos epidémicos prioritarios."
            },
            {
                "title": "Salud Animal",
                "desc": "Vacunas veterinarias para prevenir la transmisión zoonótica directamente en su origen."
            },
            {
                "title": "Sostenibilidad Ambiental",
                "desc": "Bioprocesos sostenibles y gestión ecológica de flujos biológicos y recursos energéticos."
            }
        ],
    ...
    "solutions": {
        ...
        "title": "Soluciones Biotecnológicas Integrales",
        "globalHealthChallenges": "Para Desafíos de Salud Global.",
        "desc": "Desde la investigación fundamental hasta la manufactura a escala comercial.",
        "learnMore": "Conocer Más",
        "items": [
            {
                "title": "Desarrollo de Vacunas",
                "desc": "Plataformas patentadas de ARNm y vectores virales para una respuesta rápida e inmunidad duradera."
            },
            {
                "title": "Plataformas de Diagnóstico",
                "desc": "Diagnósticos de última generación en el punto de atención con precisión molecular y análisis con IA."
            },
            {
                "title": "Bioterapéuticos Avanzados",
                "desc": "Anticuerpos monoclonales y terapias celulares diseñadas para un impacto específico en la salud global."
            },
            {
                "title": "Soporte Regulatorio",
                "desc": "Orientación experta integral a través de entornos regulatorios globales complejos y cumplimiento estricto."
            },
            {
                "title": "Manufactura GMP",
                "desc": "Red de manufactura distribuida para asegurar el acceso equitativo a medicamentos biológicos críticos."
            }
        ]
    },
    "impact": {
        "title": "Impacto Tangible en la Salud Global",
        "measuredInLives": "Medido en Vidas Salvadas.",
        "desc": "Construyendo soluciones sostenibles para los sistemas de salud en regiones en desarrollo.",
        "rdGrowth": "Trayectoria de Crecimiento en I+D",
        "growth": "Crecimiento",
        "impact": "Impacto",
        "yearEst": "Est. 2025",
        "stats": {
            ...
            "partnerships": "Alianzas Globales"
        },
        "tag": "Nuestro Impacto"
    },
    "caseStudy": {
        "titlePrefix": "Estudios de Caso",
        "titleHighlight": "Destacados",
        "desc": "Descubra cómo ayudamos a nuestros socios a superar desafíos biotecnológicos complejos.",
        "tag": "Estudios de Caso",
        "features": [
            {
                "label": "Vacunas",
                "desc": "Acelerando el acceso global a vacunas vitales mediante escalamiento rápido y seguro."
            },
            {
                "label": "Diagnósticos",
                "desc": "Pioneros en kits de prueba innovadores para una detección rápida y precisa de enfermedades."
            },
            {
                "label": "Bioterapéuticos",
                "desc": "Desarrollo de biológicos avanzados para el tratamiento de afecciones crónicas complejas."
            },
            {
                "label": "Ensayos Clínicos",
                "desc": "Conducción de ensayos clínicos éticos y rigurosos garantizando la máxima seguridad del paciente."
            },
            {
                "label": "Salud Global",
                "desc": "Fortaleciendo sistemas sanitarios y fomentando un acceso equitativo en todo el mundo."
            },
            {
                "label": "Innovación en I+D",
                "desc": "Aprovechando tecnologías de vanguardia para impulsar el futuro de la ciencia médica."
            },
            {
                "label": "Control de Calidad",
                "desc": "Cumplimiento inquebrantable de los estándares internacionales más estrictos de pureza y producción."
            },
            {
                "label": "Terapéutica",
                "desc": "Suministro de terapias dirigidas y personalizadas para contramedidas médicas prioritarias."
            }
        ],
    ...
    "blogs": {
        ...
        "desc": "Manténgase informado sobre nuestros avances científicos y logros industriales.",
        "viewAll": "Ver Todos los Artículos",
        "readMore": "Leer Más",
        "items": [
            {
                "title": "El Futuro de la Fabricación de Vacunas en Mercados Emergentes",
                "excerpt": "Explore cómo las capacidades de manufactura local reducen las disparidades de suministro mundial.",
                "date": "12 de Octubre, 2023",
                "category": "Innovación",
                "author": "Equipo TechInvention"
            },
            {
                "title": "Innovaciones en Herramientas de Diagnóstico Rápido para la Atención Médica",
                "excerpt": "Análisis profundo de nuestras soluciones de diagnóstico diseñadas para resultados precisos en el punto de atención.",
                "date": "5 de Noviembre, 2023",
                "category": "Investigación",
                "author": "Dr. Elena Rodriguez"
            },
            {
                "title": "Fortaleciendo Alianzas Globales para la Equidad en Recursos Médicos",
                "excerpt": "Por qué la colaboración público-privada es imprescindible para alcanzar la seguridad sanitaria universal.",
                "date": "20 de Diciembre, 2023",
                "category": "Tecnología",
                "author": "Equipo TechInvention"
            }
        ],
        "tag": "Noticias y Publicaciones",
        "title": "Perspectivas y Publicaciones Recientes"
    },
    "glanceVideo": {
        "titlePrefix": "TechInvention",
        "titleHighlight": "en un Vistazo",
        "title": "TechInvention en un Vistazo",
        "desc": "Conozca nuestra misión, instalaciones y equipo en acción."
    },
    "cta": {
    ...
    "loader": {
        ...
        "loading": "Cargando TechInvention..."
    },
    "homeStats": {
        "header": {
            "tag": "Nuestro Impacto",
            ...
            "desc": "Nuestro compromiso con la equidad en salud se evidencia en nuestro portafolio innovador y en el impacto positivo generado a través de las fronteras."
        },
        "awards": {
            "value": "10+",
            "label": "Años",
            "desc": "De experiencia comprobada en biotecnología y manufactura"
        },
        "experts": {
            "value": "20+",
            "label": "Proyectos",
            "desc": "Proyectos globales entregados con éxito en vacunas y salud"
        },
        "patients": {
            "value": "15+",
            "label": "Países",
            "desc": "Países beneficiados con nuestras tecnologías y alianzas"
        },
        "partners": {
            "value": "10+",
            "label": "Socios Globales",
            "desc": "Instituciones líderes de salud a nivel internacional"
        }
    },
    "globalProjects": {
        ...
        "locations": [
            ...
            },
            {
                "id": "africa",
                "name": "África",
                "type": "Centro de Manufactura y Distribución",
                "count": "8+ Proyectos",
                "coords": [
                    24,
                    -29
            ...
            },
            {
                "id": "vietnam",
                "name": "Vietnam",
                "type": "Transferencia Tecnológica",
                "count": "3+ Proyectos",
                "coords": [
                    108,
                    14
    ...
    "vaccinePipeline": {
        ...
        "targetInfants": "Bebés",
        "announceSafety": "Anuncio de datos de seguridad:",
        "phase3Trials": "Ensayos de Fase 3 en el 1S 2027²",
        "phase": "Fase",
        ...
        "desc": "Programas avanzados dirigidos a enfermedades infecciosas prioritarias y resistencia a los antimicrobianos."
    },
    "biotherapeuticsPipeline": {
        "title": "Portafolio Bioterapéutico",
        "pipeline": "Pipeline",
        "items": [
            {
                "name": "Eritropoyetina Humana Recombinante",
                "phase": "Fase 3",
                "color": "#2065B3",
                "desc": "Para el tratamiento de la anemia"
            },
            {
                "name": "Pegfilgrastim",
                "phase": "Preclínico",
                "color": "#87A840",
                "desc": "Para el tratamiento de la neutropenia"
            }
        ],
        "tag": "Bioterapéuticos",
        "desc": "Soluciones biológicas innovadoras y accesibles."
    },
    "journeyPipeline": {
        "tag": "Nuestro Impacto",
        "title1": "Portafolio de Vacunas y Bioterapéuticos",
        "title2": "Descubrimiento | Prueba de Concepto | Preclínico | Fase 1/2",
        "phases": [
            "Descubrimiento",
            "Prueba de Concepto",
            "Preclínico",
        ...
        "boxes": [
            {
                "title": "Vacuna Neumocócica Conjugada (16-valente)",
                "desc": "Plataforma glicoconjugada avanzada",
                "phase": "Prueba de Concepto"
            },
            {
                "title": "Vacuna Meningocócica Hexavalente (ABCYWX)",
                "desc": "Amplia protección contra meningococo",
                "phase": "Preclínico"
            },
            {
                "title": "Vacuna Pan-Salmonella",
                "desc": "Dirigida a cepas críticas de Salmonella",
                "phase": "Descubrimiento"
            },
            {
                "title": "Vacuna contra Shigella",
                "desc": "Innovadora vacuna glicoconjugada",
                "phase": "Prueba de Concepto"
            },
            {
                "title": "Vacuna contra Meningococo B",
                "desc": "Plataforma de proteínas recombinantes",
                "phase": "Preclínico"
            },
            {
                "title": "Vacuna contra la Malaria",
                "desc": "Candidato a vacuna de próxima generación",
                "phase": "Descubrimiento"
            },
            {
                "title": "Vacuna contra la Tuberculosis",
                "desc": "Seleccionada por TBVI para evaluación",
                "phase": "Preclínico"
            }
        ]
    },
    "membership": {
        "tag": "Red Global",
        "title": "Membresías y Colaboraciones Internacionales",
        "membership": "Membresías",
        "desc": "Alianzas estratégicas con destacadas organizaciones científicas y redes internacionales.",
        "membersTitle": "Nuestras Organizaciones Miembros",
        "howToJoin": "Hacerse Miembro",
        "joinDesc": "Únase a nuestra red de innovación para convertir la equidad en salud en una realidad."
    },
    "certifications": {
    ...
    "contact": {
        ...
        "form": {
            ...
            "successDesc": "Nuestro equipo de asesoría se comunicará en un plazo de 24 horas. Gracias por su interés.",
        ...
        "officeSlide2": "Espacio de trabajo",
        "officeSlide3": "Sala de capacitación"
    },
    "awards": {
        "tag": "Reconocimientos",
        ...
        "items": [
            {
                ...
                "desc": "Liderando nuevas iniciativas de transferencia tecnológica para fortalecer la producción regional de vacunas.",
                "image": "news_mrna"
            },
            {
                "date": "Febrero 2026",
                "category": "Alianza",
                "title": "La Alianza Global de Salud Nombra a TechInvention como Socio Estratégico",
                "desc": "Sumando esfuerzos para acelerar soluciones diagnósticas asequibles para poblaciones vulnerables.",
                "image": "news_partnership"
            },
            {
                "date": "Enero 2026",
                "category": "Investigación",
                "title": "Avance Significativo en la Vacuna contra Salmonella",
                "desc": "Resultados preclínicos altamente exitosos obtenidos para nuestro candidato a vacuna NexGen Salmonella.",
                "image": "news_mrna"
            }
        ]
    },
        ...
        "slides": [
            {
                ...
                "description": "Diagnósticos en el punto de atención de última generación con precisión molecular y análisis impulsados por IA.",
                "accent": "#1755A6",
                "imageUrl": "diagnostics"
            },
            {
                "title": "Portafolio de Vacunas",
                "subtitle": "Innovaciones en I+D",
                "description": "Pioneros en vacunas de próxima generación utilizando plataformas de ARNm y vectores virales para proteger la salud mundial.",
                "accent": "#5C7625",
                "imageUrl": "vaccine"
            },
            {
                "title": "Equidad en Salud Global",
                "subtitle": "Visión One Health",
                "description": "Promoviendo soluciones biotecnológicas accesibles y asequibles para cerrar la brecha de atención sanitaria a nivel global.",
                "accent": "#A3611C",
                "imageUrl": "equity"
            },
            {
                ...
                "description": "Apoyo integral en mapeo de patentes, licencias tecnológicas y protección de la propiedad intelectual en todo el mundo.",
                "accent": "#565658",
                "imageUrl": "ip"
            }
        ],
        "title": "Excelencia de Plataforma"
    },
    "atAGlance": {
        "tag": "Panorama",
        "title1": "TechInvention ",
        "title2": "en un Vistazo",
        "title": "En un Vistazo",
        "subtitle": "Nuestro Ecosistema e Impacto en Cifras",
        "desc": "Infraestructuras integradas dedicadas a la equidad en salud mundial."
    },
    "strategicAdvisory": {
        ...
        "sections": [
            {
                ...
                "content": "Estudios integrales de factibilidad técnica, comercial y financiera para habilitar la producción local de vacunas en mercados emergentes.",
                "deliverablesTitle": "Nuestros entregables incluyen:",
                "deliverables": [
                    "Modelado epidemiológico y demanda del mercado",
                    "Análisis de requisitos técnicos y de infraestructura",
                    "Proyecciones financieras y retorno de inversión",
                    "Hoja de ruta regulatoria y de registro",
                    "Informe de análisis de brechas",
                    "Informe de análisis técnico-comercial"
                ]
            },
            {
                "title": "Evaluaciones de Mercado",
                "content": "Análisis exhaustivos de demanda, estrategias de precios y dinámica competitiva en el sector de vacunas y productos biofarmacéuticos.",
                "deliverablesTitle": "Áreas clave de enfoque:",
                "deliverables": [
                    "Análisis de la demanda global y regional de vacunas",
                    "Dinámica de compras públicas y licitaciones",
                    "Optimización de precios y estructura de costos",
                    "Estrategias de entrada comercial"
                ]
            },
            {
                "title": "Transferencia de Tecnología y Licencias",
                "content": "Transferencia fluida de procesos y formulaciones de vacunas desde la escala de investigación hasta la manufactura comercial bajo normas GMP.",
                "deliverablesTitle": "Alcance de la transferencia:",
                "deliverables": [
                    "Transferencia de procesos y métodos analíticos",
                    "Paquetes de know-how y documentación técnica",
                    "Protocolos de validación GMP",
                    "Capacitación técnica y soporte en planta"
                ]
            },
            {
                "title": "Diseño Conceptual e Ingeniería de Plantas",
                "content": "Consultoría de ingeniería para el diseño y construcción de plantas de vacunas y biológicos en cumplimiento con normas OMS, FDA y GMP de la UE.",
                "deliverablesTitle": "Servicios de ingeniería:",
                "deliverables": [
                    "Diseño conceptual y de detalle",
                    "Optimización de áreas limpias y sistemas HVAC",
                    "Especificaciones de equipos y requerimientos de usuario (URS)",
                    "Puesta en marcha y calificación (DQ/IQ/OQ/PQ)",
                    "Suministro y especificación de equipos",
                    "Gestión de espacios y optimización de costos",
                    "Sistemas de información de edificios y automatización"
                ]
            },
            {
                "title": "Sistemas de Gestión de Calidad (SGC) y Soporte WHO-PQ",
                "content": "Orientación experta y preparación integral para la obtención de la Prequalificación de la OMS (WHO-PQ) y el cumplimiento de normativas globales.",
                "deliverablesTitle": "Nuestros entregables incluyen:",
                "deliverables": [
                    "Análisis de brechas de la planta y producto según lineamientos de la OMS",
                    "Auditoría de prueba (Mock audit) de los sistemas SGC",
                    "Cumplimiento y resolución de observaciones de auditoría",
                    "Reuniones de preevaluación con la OMS para PQ",
                    "Seguimiento y cierre de planes de acciones correctivas (CAPA)",
                    "Presentación y cumplimiento de CAPA post-auditoría"
                ]
            }
        ],
        "callToAction": "Iniciar una Asesoría Estratégica",
        "testimonials": [
            {
                "client": "Organización Mundial de la Salud (OMS)",
                "feedback": "El asesoramiento estratégico de TechInvention ha sido fundamental para fortalecer la capacidad regional de producción de vacunas."
            },
            {
                "client": "UNOPS",
                "feedback": "Su profunda experiencia técnica y formación práctica agregaron un valor incalculable a nuestros programas de bioseguridad."
            },
            {
                "client": "UNOPS – Capacitación en Analítica de Vacunas",
                "feedback": "TechInvention entregó con éxito un programa integral de capacitación en analítica de vacunas, combinando aprendizaje virtual con sesiones prácticas en instalaciones."
            },
            {
                "client": "Organización Mundial de la Salud (OMS SEARO)",
                "feedback": "Felicitamos a TechInvention por su profesionalismo, experiencia técnica y compromiso demostrado durante toda la ejecución del proyecto."
            }
        ],
    ...
    "cdmo": {
        ...
        "qcLab": {
            ...
            "title": "Laboratorio de QC y Soporte Analítico",
            "inProcess": "Pruebas en Proceso",
            "inProcessDesc": "Monitoreo en tiempo real y análisis avanzados durante todas las fases críticas de producción.",
            "release": "Pruebas de Liberación de Lotes",
            "releaseDesc": "Análisis exhaustivo del producto final cumpliendo estrictas farmacopeas mundiales.",
            "stability": "Estudios de Estabilidad",
            "stabilityDesc": "Cámaras de estabilidad conformes a ICH para rigurosos ensayos en tiempo real y acelerados."
        },
        "techTransfer": {
            "title": "Preparación para la Transferencia de Tecnología",
            "desc": "Un proceso riguroso y estructurado que garantiza una transición fluida desde la I+D hasta la fabricación comercial a gran escala.",
            "step1Title": "Recepción del Paquete Técnico",
            "step1Desc": "Revisión exhaustiva de procesos y métodos analíticos.",
            "step2Title": "Adaptación de Procesos",
            "step2Desc": "Análisis de adecuación de la planta e ingeniería de escalado.",
            "step3Title": "Lotes de Prueba de Ingeniería",
            "step3Desc": "Lotes de confirmación no-GMP para validación técnica.",
            "step4Title": "Fabricación Bajo Normas GMP",
            "step4Desc": "Producción clínica y comercial certificada con los más altos estándares."
        },
        "drugProductTitle": "Formulación y Llenado de Productos Farmacéuticos",
        "drugProductDesc": "Nuestras operaciones de llenado y acabado estéril utilizan tecnología de aisladores y RABS de última generación para garantizar la esterilidad.",
        "readyCommercial": "Listo para el envasado a escala comercial",
        "liquidVials": "Viales Líquidos y Liofilizados",
        "liquidVialsDesc": "Líneas de llenado aséptico de alta velocidad integradas con tecnología avanzada de aislamiento.",
        "pfs": "Jeringas Prellenadas (PFS)",
        "pfsDesc": "Llenado automatizado de PFS bajo estrictos controles ambientales para una máxima esterilidad.",
        "upstream": "Procesamiento Upstream",
        "upstreamDesc": "Biorreactores escalables hasta una capacidad de 2000L",
        "downstream": "Downstream Avanzado",
        "downstreamDesc": "Purificación de precisión y cromatografía",
        "drugSubstanceTitle": "Fabricación de Sustancias Farmacéuticas (Drug Substance)",
        "drugSubstanceDesc": "Procesamiento upstream y downstream robusto y eficiente para producir APIs de la más alta calidad.",
        "opExcellence": "Excelencia Operacional",
    ...
    "productsDocs": {
        ...
        "desc": "Un portafolio integral de vacunas y productos biológicos diseñados para abordar las necesidades críticas de salud pública en todo el mundo.",
        "vaccines": [
            {
                "name": "TdaPgen",
        ...
        "adverseReporting": {
            "title": "Notificación de Eventos Adversos",
            "desc": "Para consultas o para reportar un Evento Adverso (EA), comuníquese con nuestro equipo de farmacovigilancia y notificación.",
            "phone": "18008902590",
            "email": "feedback@techinvention.biz",
            "note": "La seguridad y el bienestar de los pacientes son nuestra máxima prioridad.",
            "privacyNote": "Su privacidad es fundamental para nosotros. Todos los informes de eventos adversos se manejarán con estricta confidencialidad. La información personal está protegida y se utiliza únicamente para el monitoreo de seguridad."
        },
        "adverseEvents": {
            "title": "Notificación de Eventos Adversos",
            "contactText": "Para cualquier consulta o para reportar un evento adverso, comuníquese con nuestro equipo de farmacovigilancia:",
            "phoneLabel": "Teléfono:",
            "emailLabel": "Correo electrónico:",
            "downloadLabel": "Descargar formulario de notificación:",
            "downloadLink": "Formulario de notificación de eventos adversos",
            "downloadFollowUp": "y envíe su formulario completado al correo electrónico mencionado anteriormente.",
            "privacy1": "Su privacidad es sumamente importante para nosotros.",
            "privacy2": "Todos los reportes de eventos adversos se gestionarán con la más estricta confidencialidad.",
            "privacy3": "La información personal está protegida y se utiliza únicamente para el monitoreo de seguridad farmacológica."
        }
    },
    "contactDocs": {
        "title": "Solicitud de Documentación Técnica y de Producto",
        "subtitle": "Contáctenos para dossiers regulatorios, fichas técnicas y especificaciones de producto.",
        "connectDesc": "Comuníquese con nuestro equipo para explorar alianzas, consultas de productos, colaboraciones de I+D o consultoría de plantas.",
        "address1Title": "Oficina Corporativa y Planta de Manufactura",
        "address1": "Plot No. EL-40, Mahape MIDC Electric Zone, MIDC Industrial Area, Mahape Village, Navi Mumbai, Maharashtra 400710, India",
    ...
    "products": {
        ...
        "diagFeat4": "Conforme a Normas Regulatorias Internacionales",
        "advancedDiagTitle": "Soluciones Diagnósticas Avanzadas",
        "advancedDiagDesc": "Transformando el diagnóstico con tecnologías de prueba rápidas, sólidas y precisas para combatir enfermedades infecciosas a nivel global.",
        "precisionAssays": "Ensayos de Precisión",
        "goldStandard": "Rendimiento de estándar de oro",
        "rapidDiagnostics": "Diagnóstico Rápido",
        "lfaTitle": "Ensayos de Flujo Lateral (LFA)",
        "lfaDesc": "Soluciones de diagnóstico rápido en el punto de atención que brindan resultados confiables en tiempo real para afecciones infecciosas y crónicas.",
        "rapidTest": "Prueba Rápida",
        ...
        "animalCare": "el Cuidado y la Salud Animal",
        "vetDesc": "Soluciones integrales de diagnóstico veterinario para pruebas rápidas y precisas en animales de compañía y monitoreo de ganado.",
        "vetProductsBtn": "Ver Productos Veterinarios",
        "vetItems": [
            {
                "title": "Pruebas para Animales de Compañía",
                "desc": "Ensayos diagnósticos precisos y rápidos para la salud de mascotas."
            },
            {
                "title": "Monitoreo de Salud del Ganado",
                "desc": "Detección proactiva y vigilancia epidemiológica en rebaños y aves de corral."
            },
            {
                "title": "Vigilancia de Enfermedades Zoonóticas",
                "desc": "Detección temprana de transmisión de patógenos entre especies bajo el enfoque de Una Sola Salud (One Health)."
            }
        ]
    },
    "rnd": {
    ...
    "thankYou": {
        ...
        "desc": "Hemos recibido su solicitud. Nuestro equipo se pondrá en contacto con usted a la brevedad.",
        "button": "Volver al Inicio"
    },
    "search": {
        "showingResults": "Mostrando resultados para",
        "enterPrompt": "Ingrese un término para buscar productos, vacunas, noticias y documentos",
    ...
    "home": {
        "cta": {
            "desc": "Contáctenos para explorar alianzas de fabricación en vacunas y bioterapias."
        }
    }
};
