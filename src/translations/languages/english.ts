export const english = {
        ...
        "items": [
            {
                ...
                "desc": "Proprietary mRNA and viral vector platforms for rapid response and lasting immunity."
            },
            {
                "title": "Diagnostic Platforms",
                "desc": "Next-gen point-of-care diagnostics with molecular precision and AI-driven insights."
            },
            {
                "title": "Biotherapeutics",
                "desc": "Monoclonal antibodies and cell therapies designed for targeted global health impact."
            },
            {
                "title": "Regulatory Support",
                "desc": "End-to-end guidance through complex global regulatory landscapes and compliance."
            },
            {
                "title": "Manufacturing",
                "desc": "Distributed manufacturing network for equitable access to life-critical medicines."
            }
        ]
    },
    "impact": {
    ...
    "caseStudy": {
        ...
        "features": [
            {
                "label": "Vaccines",
                "desc": "Accelerating global access to life-saving immunizations through rapid scale-up."
            },
            {
                "label": "Diagnostics",
                "desc": "Pioneering novel testing kits for faster and more accurate disease detection."
            },
            {
                "label": "Biotherapeutics",
                "desc": "Developing advanced biological therapies to treat complex chronic conditions."
            },
            {
                "label": "Clinical Trials",
                "desc": "Conducting rigorous and ethical multi-phase trials to ensure patient safety."
            },
            {
                "label": "Global Health",
                "desc": "Strengthening healthcare systems and promoting equitable access worldwide."
            },
            {
                "label": "R&D Innovation",
                "desc": "Leveraging cutting-edge technologies to drive the future of medical science."
            },
            {
                "label": "Quality Control",
                "desc": "Upholding the highest international standards for manufacturing purity."
            },
            {
                "label": "Therapeutics",
    ...
    "horizon": {
        ...
        "stages": [
            {
                "stage": "Ideate",
                "desc": "Target identification, antigen discovery, AI/ML-enabled vaccine design, and platform selection."
            },
            {
                "stage": "Develop",
                "desc": "Process and formulation development, analytical assay development, characterization, and proof-of-concept studies."
            },
            {
                "stage": "Evaluate",
                "desc": "Preclinical efficacy, safety and toxicology studies, with regulatory documentation and compliance."
            },
            {
                "stage": "Scale",
                "desc": "Process scale-up, technology transfer, GMP manufacturing readiness, and commercial translation."
            }
        ],
        "collaborations": [
            {
    ...
    "blogs": {
        ...
        "desc": "Explore expert perspectives, industry updates, and breakthrough developments in healthcare and biotechnology.",
        "viewAll": "View All Blogs",
        "readMore": "Read More",
        "items": [
            {
                "title": "The Future of Vaccine Manufacturing in Emerging Markets",
                "excerpt": "Exploring how localized production capabilities can dramatically reduce global supply chain vulnerabilities.",
                "date": "October 12, 2023",
                "category": "Innovation",
                "author": "TechInvention Team"
            },
            {
                "title": "Innovations in Rapid Diagnostic Tools for Next-Gen Healthcare",
                "excerpt": "A deep dive into our newest diagnostic solutions designed to provide accurate results in under 15 minutes.",
                "date": "November 5, 2023",
                "category": "Research",
                "author": "Dr. Elena Rodriguez"
            },
            {
                "title": "Fostering Global Partnerships for Medical Resource Equity",
                "excerpt": "Why collaboration between private and public sectors is essential to achieving universal health coverage.",
    ...
    "vaccinePipeline": {
        ...
        "items": [
            {
                "name": "Pneumococcal Conjugate Vaccine (16-valent)",
                "progress": 75,
                "color": "#1955A6"
            },
            {
                "name": "Hexavalent Meningococcal Vaccine (ABCYWX)",
                "progress": 50,
                "color": "#129B9C"
            },
            {
    ...
    "cdmo": {
        ...
        "integratedCapabilities": {
            ...
            "capabilities": [
                {
                    "title": "Upstream Manufacturing",
                    "desc": "Two flexible upstream manufacturing suites equipped with stainless-steel bioreactor systems (20 L and 100 L), enabling efficient process development, optimization, and manufacturing scale-up across diverse production platforms."
                },
                {
                    "title": "Downstream Processing",
                    "desc": "Integrated purification capabilities supporting recovery, concentration, purification, polishing, and process optimization to ensure consistent product quality and manufacturing robustness."
                },
                {
                    "title": "Drug Product Manufacturing",
                    "desc": "Flexible fill-finish capabilities through a multi-format manufacturing line supporting liquid vials and pre-filled syringes for clinical and commercial supply."
                },
                {
                    "title": "Quality, Regulatory & Technology Transfer",
                    "desc": "Comprehensive support for analytical development, quality management systems, regulatory documentation, validation, technology transfer, manufacturing readiness, and commercialization planning to enable successful product advancement."
                },
                {
                    "title": "Training & Workforce Development",
                    "desc": "Specialized hands-on training programs in vaccine manufacturing, GMP operations, quality assurance, biosafety, regulatory compliance, and advanced bioprocessing to strengthen global biomanufacturing capacity."
                }
            ]
        },
        ...
        "badges": [
            {
                ...
                "desc": "Built to support availability of essential vaccines across priority markets."
            },
            {
                "title": "Market-Ready",
                "desc": "Focused on regulated, market-authorized vaccine candidates."
            },
            {
                "title": "Partnership-Led",
                "desc": "Designed for institutional, commercial and public health collaborations."
            }
        ],
        "adverseReporting": {
    ...
    "products": {
        ...
        "labelComposition": "Label Composition",
