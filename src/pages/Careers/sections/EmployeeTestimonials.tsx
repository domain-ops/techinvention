                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((test, index) => (
                        <motion.div
                            ...
                            className="bg-slate-50 border border-slate-200/60 rounded-[2rem] p-8 text-left relative flex flex-col justify-between group hover:bg-white hover:shadow-xl hover:border-slate-200 transition-all duration-500"
                        >
                            <div>
