        ...
        <section className="py-14 md:py-16 bg-white font-sans border-b border-slate-100">
            <div className="max-w-[1300px] mx-auto px-6">
                <div>
                    ...
                    >
                        <p className="text-slate-800 text-base md:text-[17px] leading-relaxed mb-4 font-medium">
                            {t('contact.introP1') || "Whether you are exploring partnerships, product enquiries, R&D collaborations, scale-up and manufacturing opportunities or consultancy support for capacity building, our team would be pleased to hear from you."}
                        </p>
                        <p className="text-slate-800 text-base md:text-[17px] leading-relaxed mb-8 font-medium">
                            {t('contact.introP2') || (
                                <>
                        ...
                        >
                            {t('contact.startConversation') || "Start a Conversation"}
